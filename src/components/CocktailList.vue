...
export default {
  ...
  methods: {
    async getCocktailInformationsAsync() {
      ...
      const response = await fetch(`https://www.thecocktaildb.com/api/json/v2/${apiKey}/randomselection.php`)
      const data = await response.json();
      this.drinks = data.drinks;
    },
    async onNewRandomCocktailClickAsync() {
      await this.getCocktailInformationsAsync();
    }
  }
}
